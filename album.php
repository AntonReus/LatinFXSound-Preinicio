...
<!-- CLASS -->
    ...
    <section class="biblio d-flex flex-column justify-content-center align-items-center" role="document"><p><p></p></p>
        ...
        $db = conectar();
        $sql = "SELECT * FROM canciones WHERE nombre='$_POST[buscarC]'|| album='$_POST[buscarC]'";
    ...
    ?>        
            ...
            <tr>
                ...
                <td style="hero5"><?php echo $mostrar['nombre'] ?></td>                
                <td style="hero5"><?php echo $mostrar['duracion'] ?></td>
                <td style="hero5"><?php echo $mostrar['bpm'] ?></td>
                <td style="hero5"><?php echo $mostrar['album'] ?></td>
